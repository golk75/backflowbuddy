...
public class DCPressureZoneHUDController : MonoBehaviour
{

    //game objects

    public DCWaterController m_dcWaterController;
    ...
    void SetVisualElements()
    {
        ...
        m_SupplyPressureTextField.text = m_dcWaterController.supplyPsi.ToString();
        check1SpringPressure = m_dcWaterController.check1SpringForce;
        check2SpringPressure = m_dcWaterController.check2SpringForce;
    ...
    void CheckSpring2Regulate()
    {
        if (m_dcWaterController.isActiveAndEnabled)
        {
            m_dcWaterController.check2SpringForce = check2SpringPressure;
        }
        else
        {
