...
namespace com.zibra.liquid.Editor.Solver
{
    ...
    internal class ZibraLiquidEditor : UnityEditor.Editor
    {
        ...
        private static void CreateZibraLiquid(MenuCommand menuCommand)
        {
            ...
            String emitterName = "Zibra Effects Liquid Emitter " + (Manipulator.AllManipulators.Count + 1);
        ...
        {
            // Create a custom game object
            String name = "Zibra Effects Liquid Emitter " + (Manipulator.AllManipulators.Count + 1);
        ...
        {
            String name = "Zibra Effects Liquid Void " + (Manipulator.AllManipulators.Count + 1);
            // Create a custom game object
            var go = new GameObject(name);
            var newSDF = go.AddComponent<AnalyticSDF>();
            newSDF.ChosenSDFType = AnalyticSDF.SDFType.Box;
        ...
        {
            String name = "Zibra Effects Liquid Detector " + (Manipulator.AllManipulators.Count + 1);
            // Create a custom game object
            var go = new GameObject(name);
            var newSDF = go.AddComponent<AnalyticSDF>();
            newSDF.ChosenSDFType = AnalyticSDF.SDFType.Box;
        ...
        {
            String name = "Zibra Effects Liquid Force Field " + (Manipulator.AllManipulators.Count + 1);
            // Create a custom game object
            var go = new GameObject(name);
            var newSDF = go.AddComponent<AnalyticSDF>();
        ...
        {
            String name = "Zibra Effects Liquid Species Modifier " + (Manipulator.AllManipulators.Count + 1);
            // Create a custom game object
            var go = new GameObject(name);
        ...
        {
            String name = "Zibra Effects Liquid Analytic Collider " + (Manipulator.AllManipulators.Count + 1);
            // Create a custom game object
            var go = new GameObject(name);
            var newSDF = go.AddComponent<AnalyticSDF>();
