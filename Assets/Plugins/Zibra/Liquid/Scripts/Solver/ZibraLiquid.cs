...
#region Interop structures
        ...
        private bool SetMaterialParams(Camera cam)
        {
            ...
            if (usingMainMaterial)
            {
                ...
                else
                {
                    ...
                    CurrentMaterial.SetKeyword(new LocalKeyword(CurrentMaterial.shader, "USE_CUBEMAP_REFRACTION"),
                        MaterialParameters.UseCubemapRefraction);
                ...
                CurrentMaterial.SetTexture("MeshDepth", Depth, RenderTextureSubElement.Depth);
                ...
                if (!EnableDownscale)
                {
                    CurrentMaterial.DisableKeyword("FLIP_BACKGROUND_TEXTURE");
                ...
                else
                {
                    ...
                    CurrentMaterial.EnableKeyword("FLIP_BACKGROUND_TEXTURE");
                    CurrentMaterial.DisableKeyword("FLIP_PARTICLES_TEXTURE");
                }
#endif
        ...
        internal void RenderLiquidNative(CommandBuffer cmdBuffer, Camera cam, Rect? viewport = null)
        {
            ...
            {
                cmdBuffer.SetComputeVectorParam(MaterialParameters.RendererCompute, "Resolution",
                                                new Vector2(cam.pixelWidth, cam.pixelHeight));
                cmdBuffer.SetComputeTextureParam(MaterialParameters.RendererCompute, CopyDepthID, "_DepthOUT", DepthTexture);
